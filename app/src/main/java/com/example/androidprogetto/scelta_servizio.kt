...
class scelta_servizio : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_scelta_servizio)
        setSupportActionBar(findViewById<Toolbar>(R.id.toolbarmenu))

        val imageTavolo = findViewById<ImageView>(R.id.servizioTavolo)
        imageTavolo.setOnClickListener{
            val intent = Intent(this, selzione_prodotti::class.java)
            startActivity(intent)
        }

        val imageAsporto = findViewById<ImageView>(R.id.servizioAsporto)
        imageAsporto.setOnClickListener{
            val intent = Intent(this, selzione_prodotti::class.java)
            startActivity(intent)
        }
